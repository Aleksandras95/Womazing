...
$opt_name = 'redux_params';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Править контент', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Править контент', 'your-textdomain-here' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Настройки главной страници', 'your-textdomain-here' ),
		'id'               => 'basic',
...
require_once get_template_directory() ."/inc/redux-components/home/offer-section.php";
require_once get_template_directory() ."/inc/redux-components/home/collection-section.php";
require_once get_template_directory() ."/inc/redux-components/home/features-section.php";
require_once get_template_directory() ."/inc/redux-components/home/team-section.php";


// About-brand
require_once get_template_directory() . "/inc/redux-components/about-brand.php";

// Contacts
require_once get_template_directory() . "/inc/redux-components/contacts.php";
/*
 * <--- END SECTIONS
 */
